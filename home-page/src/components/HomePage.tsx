      ...
      <main className={styles.main}>
        ...
        <div className={styles.center}>
          ...
          <div className={styles.spaces}>
            <div className={styles.spaceCard}>
              <Image src="/patient.png" alt="PP" width={45} height={60} />
              <p>Patient Space</p>
              <button className={styles.smallBtn}>View Result</button>
            </div>
            <div className={styles.spaceCard}>
              <Image src="/doctor.png" alt="Doctor" width={60} height={60} />
              <p>Doctor Space</p>
              <button className={styles.smallBtn}>View Result</button>
            </div>
          </div>
        ...
        <aside >
          ...
          <div className={styles.newsCard}>
            ...
            <button onClick={() => router.push("/news")} className={styles.readMore}>Read more</button>
          </div>
          </div>    
        </aside>
      </main>
